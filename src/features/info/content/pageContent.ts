...
const pageContents: Record<string, { en: InfoPage; ar: InfoPage }> = {
  "about": {
    en: {
      ...
      slug: "about",
      sections: [
        { type: "text", title: "Our Story", content: "<p>Catch Beauty started as a simple idea: to make authentic beauty and personal care products accessible to everyone in Egypt. What began as a small online store has grown into one of the country's most trusted e-commerce destinations for beauty enthusiasts.</p><p>Founded in 2015, Catch Beauty has since partnered with over 500 local and international brands to offer a curated selection of cosmetics, skincare, fragrances, haircare, and personal care essentials. From luxury brands to affordable everyday essentials, we cater to every budget and preference.</p>" },
    ...
    ar: {
      ...
      slug: "about",
      sections: [
        { type: "text", title: "قصتنا", content: "<p>بدأت كيتش بيوتي كفكرة بسيطة: جعل منتجات التجميل والعناية الشخصية الأصلية في متناول الجميع في مصر. ما بدأ كمتجر صغير عبر الإنترنت نما ليصبح واحداً من أكثر وجهات التجارة الإلكترونية الموثوقة في مصر لعشاق الجمال.</p><p>تأسست كيتش بيوتي في عام 2015، ومنذ ذلك الحين تعاونت مع أكثر من 500 علامة تجارية محلية وعالمية لتقديم مجموعة منتقاة من مستحضرات التجميل والعناية بالبشرة والعطور.</p>" },
        { type: "image", src: "https://placehold.co/1200x600/EEE/999?text=فريق+كيتش+بيوتي" },
  ...
  "contact": {
    ...
    ar: {
      ...
      slug: "contact",
      sections: [
        { type: "text", title: "نحن هنا لمساعدتك", content: "<p>هل لديك سؤال أو استفسار أو ملاحظة؟ يسعدنا سماعك. فريق خدمة العملاء لدينا متاح لمساعدتك.</p><h3>خدمة العملاء</h3><ul><li><strong>الهاتف:</strong> 16061 (الأحد إلى الخميس، 9:00 ص - 9:00 م)</li><li><strong>البريد الإلكتروني:</strong> info@catchbeauty.com</li></ul><h3>المكتب الرئيسي</h3><p>كيتش بيوتي مصر<br>5 شارع المرشدي، الماظة<br>مصر الجديدة، القاهرة، مصر</p>" },
        { type: "image", src: "https://placehold.co/800x400/EEE/999?text=خريطة+-+موقع+كيتش+بيوتي" },
  ...
  "disclosure": {
    ...
    ar: {
      ...
      slug: "disclosure",
      sections: [
        { type: "text", title: "معلومات الشركة", content: "<p>امتثالاً للوائح التجارة الإلكترونية المصرية، يتم توفير المعلومات التالية للأغراض القانونية والتنظيمية.</p><h3>بيانات الشركة</h3><ul><li><strong>الاسم القانوني:</strong> كيتش بيوتي للتجارة الإلكترونية</li><li><strong>السجل التجاري:</strong> 123456789</li><li><strong>الرقم الضريبي:</strong> 987-654-321</li><li><strong>العنوان المسجل:</strong> 5 شارع المرشدي، الماظة، مصر الجديدة، القاهرة</li></ul><h3>معلومات الاتصال</h3><ul><li><strong>الهاتف:</strong> 16061</li><li><strong>البريد الإلكتروني:</strong> legal@catchbeauty.com</li></ul>" }
      ]
    }
  },
  "extended-warranty": {
  ...
  "loyalty": {
    ...
    ar: {
      ...
      slug: "loyalty",
      sections: [
        { type: "text", title: "برنامج مكافآت كيتش بيوتي", content: "<p>مرحباً بك في مكافآت كيتش بيوتي — برنامج الولاء الحصري المصمم لشكرك على ثقتك ودعمك المستمر. اربح نقاطاً مع كل عملية شراء واستبدلها بخصومات ومنتجات مجانية ومزايا حصرية.</p><h3>كيف يعمل</h3><ol><li><strong>التسجيل:</strong> أنشئ حساباً مجاناً في كيتش بيوتي وانضم تلقائياً</li><li><strong>اكسب النقاط:</strong> اربح نقطة واحدة لكل 10 جنيهات إنفاق</li><li><strong>الاستبدال:</strong> استبدل 100 نقطة بخصم 10 جنيهات على مشترياتك القادمة</li></ol>" },
  ...
  "newsletter": {
    ...
    ar: {
      ...
      slug: "newsletter",
      sections: [
        { type: "text", title: "اشترك في نشرتنا البريدية", content: "<p>ابق على اطلاع بأحدث المنتجات والعروض الحصرية ونصائح الجمال. اشترك في النشرة البريدية لكيتش بيوتي ولا تفوت العروض الرائعة!</p><h3>مزايا الاشتراك</h3><ul><li><strong>خصومات حصرية:</strong> احصل على رموز ترويجية وعروض خاصة للمشتركين فقط</li><li><strong>وصول مبكر:</strong> كن أول من يعرف عن إطلاق المنتجات الجديدة والتخفيضات السريعة</li><li><strong>نصائح الجمال:</strong> احصل على نصائح الخبراء حول العناية بالبشرة والمكياج</li><li><strong>توصيات مخصصة:</strong> اقتراحات منتجات مصممة حسب تفضيلاتك</li></ul><p>يمكنك إلغاء الاشتراك في أي وقت. نحن نحترم خصوصيتك ولن نشارك بريدك الإلكتروني مع أطراف ثالثة.</p>" }
      ]
    }
  },
  "payment": {
    ...
    ar: {
      ...
      sections: [
        ...
        { type: "text", title: "الأمان", content: "<p>في كيتش بيوتي، نأخذ أمان الدفع على محمل الجد. بوابة الدفع الخاصة بنا متوافقة مع PCI DSS، مما يضمن معالجة بيانات الدفع حسب أعلى معايير الأمان.</p>" }
      ]
    }
  },
  "privacy": {
  ...
  "service-warranty": {
    ...
    ar: {
      ...
      slug: "service-warranty",
      sections: [
        { type: "text", title: "تغطية الضمان", content: "<p>جميع المنتجات المشتراة من كيتش بيوتي مشمولة بضمان شامل من الشركة المصنعة ضد عيوب المواد والصناعة.</p><ul><li><strong>الإلكترونيات والأجهزة:</strong> ضمان لمدة عام واحد</li><li><strong>أجهزة التجميل:</strong> ضمان 6 أشهر</li><li><strong>العطور ومستحضرات التجميل:</strong> مضمونة الأصالة</li></ul>" },
  ...
  "stores": {
    ...
    ar: {
      ...
      slug: "stores",
      sections: [
        { type: "text", title: "اعثر على فرع كيتش بيوتي بالقرب منك", content: "<p>قم بزيارة فروعنا الفعلية لتجربة منتجاتنا شخصياً. موظفونا المدربون جاهزون لمساعدتك.</p><h3>الفرع الرئيسي</h3><p><strong>العنوان:</strong> 5 شارع المرشدي، الماظة، مصر الجديدة، القاهرة<br><strong>المواعيد:</strong> الأحد إلى الخميس، 10:00 ص - 8:00 م</p><h3>فرع سيتي ستارز</h3><p><strong>العنوان:</strong> سيتي ستارز، الطابق الأول، مدينة نصر، القاهرة<br><strong>المواعيد:</strong> يومياً، 10:00 ص - 11:00 م</p><h3>فرع مول العرب</h3><p><strong>العنوان:</strong> مول العرب، الطابق الأرضي، الشيخ زايد، الجيزة<br><strong>المواعيد:</strong> يومياً، 10:00 ص - 11:00 م</p><h3>فرع سان ستيفانو</h3><p><strong>العنوان:</strong> سان ستيفانو جراند بلازا، الطابق الأرضي، الإسكندرية<br><strong>المواعيد:</strong> يومياً، 10:00 ص - 11:00 م</p>" }
      ]
    }
  },
  "terms": {
