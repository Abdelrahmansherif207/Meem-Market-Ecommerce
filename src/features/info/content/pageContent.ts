...
const pageContents: Record<string, { en: InfoPage; ar: InfoPage }> = {
  "about": {
    en: {
      title: "About Meem Market",
      slug: "about",
      sections: [
        { type: "text", title: "Our Story", content: "<p>Meem Market started as a simple idea: to make authentic beauty and personal care products accessible to everyone in Egypt. What began as a small online store has grown into one of the country's most trusted e-commerce destinations for beauty enthusiasts.</p><p>Founded in 2015, Meem Market has since partnered with over 500 local and international brands to offer a curated selection of cosmetics, skincare, fragrances, haircare, and personal care essentials. From luxury brands to affordable everyday essentials, we cater to every budget and preference.</p>" },
        { type: "image", src: "https://placehold.co/1200x600/EEE/999?text=Meem+Market+Team" },
    ...
    ar: {
      ...
      slug: "about",
      sections: [
        { type: "text", title: "قصتنا", content: "<p>بدأت ميم ماركت كفكرة بسيطة: جعل منتجات التجميل والعناية الشخصية الأصلية في متناول الجميع في مصر. ما بدأ كمتجر صغير عبر الإنترنت نما ليصبح واحداً من أكثر وجهات التجارة الإلكترونية الموثوقة في مصر لعشاق الجمال.</p><p>تأسست ميم ماركت في عام 2015، ومنذ ذلك الحين تعاونت مع أكثر من 500 علامة تجارية محلية وعالمية لتقديم مجموعة منتقاة من مستحضرات التجميل والعناية بالبشرة والعطور.</p>" },
        { type: "image", src: "https://placehold.co/1200x600/EEE/999?text=فريق+ميم+ماركت" },
  ...
  "contact": {
    ...
    ar: {
      ...
      slug: "contact",
      sections: [
        { type: "text", title: "نحن هنا لمساعدتك", content: "<p>هل لديك سؤال أو استفسار أو ملاحظة؟ يسعدنا سماعك. فريق خدمة العملاء لدينا متاح لمساعدتك.</p><h3>خدمة العملاء</h3><ul><li><strong>الهاتف:</strong> 16061 (الأحد إلى الخميس، 9:00 ص - 9:00 م)</li><li><strong>البريد الإلكتروني:</strong> info@meemmarket.com</li></ul><h3>المكتب الرئيسي</h3><p>ميم ماركت مصر<br>5 شارع المرشدي، الماظة<br>مصر الجديدة، القاهرة، مصر</p>" },
        { type: "image", src: "https://placehold.co/800x400/EEE/999?text=خريطة+-+موقع+ميم+ماركت" },
  ...
  "disclosure": {
    ...
    ar: {
      ...
      slug: "disclosure",
      sections: [
        { type: "text", title: "معلومات الشركة", content: "<p>امتثالاً للوائح التجارة الإلكترونية المصرية، يتم توفير المعلومات التالية للأغراض القانونية والتنظيمية.</p><h3>بيانات الشركة</h3><ul><li><strong>الاسم القانوني:</strong> ميم ماركت للتجارة الإلكترونية</li><li><strong>السجل التجاري:</strong> 123456789</li><li><strong>الرقم الضريبي:</strong> 987-654-321</li><li><strong>العنوان المسجل:</strong> 5 شارع المرشدي، الماظة، مصر الجديدة، القاهرة</li></ul><h3>معلومات الاتصال</h3><ul><li><strong>الهاتف:</strong> 16061</li><li><strong>البريد الإلكتروني:</strong> legal@meemmarket.com</li></ul>" }
      ]
    }
  },
  "extended-warranty": {
  ...
  "loyalty": {
    en: {
      ...
      slug: "loyalty",
      sections: [
        { type: "text", title: "Meem Market Rewards Program", content: "<p>Welcome to Meem Market Rewards — our exclusive loyalty program designed to thank you for your continued trust and support. Earn points with every purchase and redeem them for discounts, free products, and exclusive perks.</p><h3>How It Works</h3><ol><li><strong>Sign Up:</strong> Create a free Meem Market account and automatically join the rewards program</li><li><strong>Earn Points:</strong> Earn 1 point for every EGP 10 spent. Bonus points available on selected products and special promotions</li><li><strong>Redeem:</strong> Exchange 100 points for EGP 10 discount on your next purchase</li></ol>" },
    ...
    ar: {
      ...
      slug: "loyalty",
      sections: [
        { type: "text", title: "برنامج مكافآت ميم ماركت", content: "<p>مرحباً بك في مكافآت ميم ماركت — برنامج الولاء الحصري المصمم لشكرك على ثقتك ودعمك المستمر. اربح نقاطاً مع كل عملية شراء واستبدلها بخصومات ومنتجات مجانية ومزايا حصرية.</p><h3>كيف يعمل</h3><ol><li><strong>التسجيل:</strong> أنشئ حساباً مجاناً في ميم ماركت وانضم تلقائياً</li><li><strong>اكسب النقاط:</strong> اربح نقطة واحدة لكل 10 جنيهات إنفاق</li><li><strong>الاستبدال:</strong> استبدل 100 نقطة بخصم 10 جنيهات على مشترياتك القادمة</li></ol>" },
  ...
  "newsletter": {
    en: {
      ...
      slug: "newsletter",
      sections: [
        { type: "text", title: "Subscribe to Our Newsletter", content: "<p>Stay up to date with the latest products, exclusive offers, beauty tips, and more. Subscribe to the Meem Market newsletter and never miss out on great deals!</p><h3>Benefits of Subscribing</h3><ul><li><strong>Exclusive Discounts:</strong> Receive subscriber-only promo codes and special offers</li><li><strong>Early Access:</strong> Be the first to know about new product launches and flash sales</li><li><strong>Beauty Tips:</strong> Get expert advice on skincare routines, makeup tutorials, and product recommendations</li><li><strong>Personalized Recommendations:</strong> Receive product suggestions tailored to your preferences and purchase history</li></ul><p>You can unsubscribe at any time. We respect your privacy and will never share your email with third parties.</p>" }
      ]
    },
    ar: {
      ...
      slug: "newsletter",
      sections: [
        { type: "text", title: "اشترك في نشرتنا البريدية", content: "<p>ابق على اطلاع بأحدث المنتجات والعروض الحصرية ونصائح الجمال. اشترك في النشرة البريدية لميم ماركت ولا تفوت العروض الرائعة!</p><h3>مزايا الاشتراك</h3><ul><li><strong>خصومات حصرية:</strong> احصل على رموز ترويجية وعروض خاصة للمشتركين فقط</li><li><strong>وصول مبكر:</strong> كن أول من يعرف عن إطلاق المنتجات الجديدة والتخفيضات السريعة</li><li><strong>نصائح الجمال:</strong> احصل على نصائح الخبراء حول العناية بالبشرة والمكياج</li><li><strong>توصيات مخصصة:</strong> اقتراحات منتجات مصممة حسب تفضيلاتك</li></ul><p>يمكنك إلغاء الاشتراك في أي وقت. نحن نحترم خصوصيتك ولن نشارك بريدك الإلكتروني مع أطراف ثالثة.</p>" }
      ]
    }
  },
  "payment": {
    ...
    ar: {
      ...
      sections: [
        ...
        { type: "text", title: "الأمان", content: "<p>في ميم ماركت، نأخذ أمان الدفع على محمل الجد. بوابة الدفع الخاصة بنا متوافقة مع PCI DSS، مما يضمن معالجة بيانات الدفع حسب أعلى معايير الأمان.</p>" }
      ]
    }
  },
  "privacy": {
  ...
  "service-warranty": {
    en: {
      ...
      sections: [
        { type: "text", title: "Warranty Coverage", content: "<p>All products purchased from Meem Market are covered by a comprehensive manufacturer warranty against defects in materials and workmanship. The warranty period and coverage terms vary depending on the product category.</p><ul><li><strong>Electronics and electrical appliances:</strong> Covered by a 1-year manufacturer warranty from the date of purchase</li><li><strong>Beauty and personal care devices:</strong> 6-month warranty covering manufacturing defects</li><li><strong>Fragrances and cosmetics:</strong> Guaranteed authentic and sealed. Claims for manufacturing defects accepted within 7 days of delivery</li></ul>" },
    ...
    ar: {
      ...
      slug: "service-warranty",
      sections: [
        { type: "text", title: "تغطية الضمان", content: "<p>جميع المنتجات المشتراة من ميم ماركت مشمولة بضمان شامل من الشركة المصنعة ضد عيوب المواد والصناعة.</p><ul><li><strong>الإلكترونيات والأجهزة:</strong> ضمان لمدة عام واحد</li><li><strong>أجهزة التجميل:</strong> ضمان 6 أشهر</li><li><strong>العطور ومستحضرات التجميل:</strong> مضمونة الأصالة</li></ul>" },
  ...
  "stores": {
    ...
    ar: {
      ...
      slug: "stores",
      sections: [
        { type: "text", title: "اعثر على فرع ميم ماركت بالقرب منك", content: "<p>قم بزيارة فروعنا الفعلية لتجربة منتجاتنا شخصياً. موظفونا المدربون جاهزون لمساعدتك.</p><h3>الفرع الرئيسي</h3><p><strong>العنوان:</strong> 5 شارع المرشدي، الماظة، مصر الجديدة، القاهرة<br><strong>المواعيد:</strong> الأحد إلى الخميس، 10:00 ص - 8:00 م</p><h3>فرع سيتي ستارز</h3><p><strong>العنوان:</strong> سيتي ستارز، الطابق الأول، مدينة نصر، القاهرة<br><strong>المواعيد:</strong> يومياً، 10:00 ص - 11:00 م</p><h3>فرع مول العرب</h3><p><strong>العنوان:</strong> مول العرب، الطابق الأرضي، الشيخ زايد، الجيزة<br><strong>المواعيد:</strong> يومياً، 10:00 ص - 11:00 م</p><h3>فرع سان ستيفانو</h3><p><strong>العنوان:</strong> سان ستيفانو جراند بلازا، الطابق الأرضي، الإسكندرية<br><strong>المواعيد:</strong> يومياً، 10:00 ص - 11:00 م</p>" }
      ]
    }
  },
  "terms": {
